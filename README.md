...
The live site walks through featured projects — each with a video, an overview, and
the tech behind it. A few highlights:

| Project | Focus |
| --- | --- |
| **Aurora** | Continental-scale real-time flight simulator |
| **Sentinel** | VR industrial safety training with automatic scoring |
| **Atlas** | Live digital twin of a manufacturing line |
| **Oracle** | In-world conversational AI assistant |

## Get in touch

- **Email:** johncampbell5050@gmail.com

---

<sub>Built with React, Vite, and Framer Motion. Run locally with `npm install` then
`npm run dev`; `npm run build` produces the production site. Deploys automatically
to GitHub Pages on every push to `main`.</sub>
